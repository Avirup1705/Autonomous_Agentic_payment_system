    ...
    <div className={`landing-page ${isMenuOpen ? 'menu-open' : ''}`} style={{ scrollBehavior: 'smooth' }}>
      ...
      <nav className="landing-nav">
        <div className="nav-brand">
          <span className="brand-name">Payventory</span>
        </div>
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Welcome to Payventory — Your AI-Powered Solution for Inventory Insights and
      ...
      <footer className="landing-footer">
        ...
        <h3 className="footer-title">Sign up for the Payventory Newsletter</h3>
        ...
        <p className="footer-copyright">© 2026 Payventory. All rights reserved.</p>
      </footer>
    </div>
  );
}
