...
PROJECT_ROOT = Path(__file__).resolve().parents[2]
OWNER_INVENTORY = PROJECT_ROOT / "src" / "ml" / "data" / "processed_dataset" / "inventory.csv"
...
def run_agent(config: Optional[dict] = None) -> dict:
    ...
    logger.info("Loading supplier inventory...")
    ...
    logger.info("Running core decision loop...")
